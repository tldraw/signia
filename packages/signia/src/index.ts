 ...
 *    `signia` uses a reactivity system based on clocks rather than callbacks, which allows caching of signal values without causing memory leaks even if a signal is not part of an active subscription.
 *
